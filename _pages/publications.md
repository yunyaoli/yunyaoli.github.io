...
### 2026
- **PAGER: Proactive Monitoring Agent for Enterprise AI Assistant**. Sujan Dutta, Junior Francisco Garcia Ayala, Pranav Pujar, Sai Sree Harsha, Dan Luo, Nikhil Vasudeva, Bikas Saha, Pritom Baruah, **Yunyao Li**. To appear in _CAIS (Demonstration Track)_ 2026.
...
- **PAGER: Proactive Monitoring Agent for Enterprise AI Assistant**. Sujan Dutta, Junior Francisco Garcia Ayala, Pranav Pujar, Sai Sree Harsha, Dan Luo, Nikhil Vasudeva, Bikas Saha, Pritom Baruah, **Yunyao Li**. In _AAAI (Demonstration Track)_ 2026.

### 2025
- **[Is Passive Expertise-Based Personalization Enough? A Case Study in AI-Assisted Test-Taking](https://arxiv.org/abs/2511.23376)** Li Siyan, Jason Zhang, Akash Maharaj, Yuanming Shi, Yunyao Li. In _PALS Workshop_ @EMNLP 2025
...
- **[Adobe Summit Concierge Evaluation with Human-in-the-loop](https://openreview.net/forum?id=pbonQsJgzI)**. Yiru Chen, Sally Fang, Sai Sree Harsha, Dan Luo, Vaishnavi Muppala, Fei Wu, Shun Jiang, Kun Qian, **Yunyao Li**. In _DaSH Workshop @VLDB_ 2025
- **[EVOSCHEMA: Towards Text-to-SQL Robustness Against Schema Evolution](https://www.vldb.org/pvldb/vol18/p3655-zhang.pdf)**. Tianshu Zhang, Kun Qian, Siddhartha Sahai, Yuan Tian, Shaddy Garg, Huan Sun, **Yunyao Li**. In _PVLDB_ 2025. 
- **[Doc-React: Multi-page Heterogeneous Document Question-answering](https://aclanthology.org/2025.acl-short.6/)**. Junda Wu, Yu Xia, Tong Yu, Xiang Chen, Sai Sree Harsha, Akash V Maharaj, Ruiyi Zhang, Victor Bursztyn, Sungchul Kim, Ryan A. Rossi, Julian McAuley, **Yunyao Li**, Ritwik Sinha. In _ACL_ 2025
- **[Grounding Pixels in Facts: Distilled Knowledge Retrieval for Factual Text-to-Video Generation](https://cvpr.thecvf.com/virtual/2025/demonstration/35933)**. Daniel Lee, Arjun Chandra, Yang Zhou, **Yunyao Li**, Simone Conia. In _CVPR (Demonstration Track)_ 2025
...
- **[ECLAIR: Enhanced Clarification for Interactive Responses in an Enterprise AI Assistant](https://ojs.aaai.org/index.php/AAAI/article/view/35152)**. John Murzaku, Zifan Liu, Vaishnavi Muppala, Mehrab Tanjim, Xiang Chen, **Yunyao Li**. In _AAAI (Demonstration Track)_ 2025.
- **[Rewind and Render: Towards Factually Accurate Text-to-Video Generation with Distilled Knowledge Retrieval](https://ojs.aaai.org/index.php/AAAI/article/view/35356)**. Daniel Lee, Arjun Chandra, Yang Zhou, **Yunyao Li**, Simone Conia. In _AAAI (Demonstration Track)_ 2025.
...
- **[Evaluation and Continual Improvement for an Enterprise AI Assistant](https://aclanthology.org/2024.dash-1.3/)**. Akash V. Maharaj, Kun Qian, Uttaran Bhattacharya, Sally Fang, Horia Galatanu, Manas Garg, Rachel Hanessian, Nishant Kapoor, Ken Russell, Shivakumar Vaithyanathan, and **Yunyao Li**. In _DaSH Workshop NAACL_ 2024 ([blog](https://blog.developer.adobe.com/ai-assistant-in-adobe-experience-platform-evaluation-and-continual-improvement-7cbc584c29f6))
